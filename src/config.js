...
const productProcessAlias = 'flex-product-default-process/release-1';
const bookingDailyProcessAlias = 'flex-daily-default-process/release-1';
const bookingPaidProcessAlias = 'flex-hourly-paid-default-process/release-1';
const productPaidProcessAlias = 'flex-product-paid-default-process/release-1';
const bookingDailyPaidProcessAlias = 'flex-daily-paid-default-process/release-1';
...
// const siteFacebookPage = 'https://www.facebook.com/profile.php?id=100090073735245';
// const siteYoutubePage = 'https://www.youtube.com/channel/UCtw8j-2S5ueo8GrbdTMQZYQ';
// const siteInstagramPage = 'https://www.instagram.com/swappiamo/';
// const siteTiktokPage = 'https://www.tiktok.com/@swappiamocommunity?lang=it-IT';
const siteTelegramPage = 'https://t.me/swappiamo';
const mainSearchType = 'keywords';
// const siteLinkedinPage = 'https://www.linkedin.com/company/swappiamo';
// Social logins & SSO
...
const config = {
  ...
  maps,
  custom,
  bookingPaidProcessAlias,
  productPaidProcessAlias,
  bookingDailyPaidProcessAlias,
};
