...
export function requestShowListing(actionPayload) {
  return (dispatch, getState, sdk) => {
    ...
    const queryParams = { include: ['currentStock', 'images'] };
...
export function compareAndSetStock(listingId, oldTotal, newTotal) {
  return (dispatch, getState, sdk) => {
    ...
    console.log('compareAndSetStock', listingId, oldTotal, newTotal);
    return sdk.stock
...
const updateStockOfListingMaybe = (listingId, stockTotals, dispatch) => {
  ...
  console.log('hasStockTotals', hasStockTotals);
...
export function requestUpdateListing(tab, data) {
  return (dispatch, getState, sdk) => {
    ...
    const { stockUpdate, id, ...rest } = data;
    let updateResponse;
    console.log('requestUpdateListing', data);
    return updateStockOfListingMaybe(id, stockUpdate, dispatch)
      .then(() => sdk.ownListings.update({ ...rest, id }))
      .then(response => {
