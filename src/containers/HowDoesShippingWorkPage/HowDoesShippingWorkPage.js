...
import css from './HowDoesShippingWorkPage.module.css';
import HowDoesShippingWork from './HowDoesShippingWork';

const HowDoesShippingWorkPageComponent = props => {
  ...
  return (
    <Page title={schemaTitle} scrollingDisabled={scrollingDisabled} schema={schema}>
      <LayoutSideNavigation>
        <LayoutWrapperTopbar>
          <TopbarContainer currentPage="HowDoesShippingWorkPage" />
        </LayoutWrapperTopbar>
...
HowDoesShippingWorkPageComponent.propTypes = {
...
const HowDoesShippingWorkPage = compose(
  connect(mapStateToProps),
  injectIntl
)(HowDoesShippingWorkPageComponent);

export default HowDoesShippingWorkPage;
