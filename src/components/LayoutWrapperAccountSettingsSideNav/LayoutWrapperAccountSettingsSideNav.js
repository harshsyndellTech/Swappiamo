...
const LayoutWrapperAccountSettingsSideNavComponent = props => {
  ...
  const tabs = [
    ...
    {
      text: <FormattedMessage id="DeleteAccount" />,
      text: (
        <FormattedMessage id="LayoutWrapperAccountSettingsSideNav.LayoutWrapperAccountSettingsSideNav.deleteAccountTitle" />
      ),
      selected: currentTab === 'DeleteAccountPage',
      id: 'DeleteAccountPageTab',
      linkProps: {
  ...
  return <LayoutWrapperSideNav type="account" tabs={tabs} />;
};
