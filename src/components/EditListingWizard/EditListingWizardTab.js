...
export const SUPPORTED_TABS = [DESCRIPTION, LOCATION, PRICING, AVAILABILITY, PHOTOS];
...
const EditListingWizardTab = props => {
  ...
  const category = listing.attributes.publicData.category || params.category;
  const sectionCategoryLabel = (
    <div className={css.categoryCategory}>
      <p className={css.category}>
        {config.custom.listingTypes.find(item => item.key === category)?.label}
      </p>
    </div>
  );
  ...
  switch (tab) {
    ...
    case PRICING: {
      ...
      //   isNewListingFlow && category === 'service'
      //     ? 'EditListingWizard.saveNewPricing'
      //     : isNewListingFlow && category === 'product'
      //     ? 'EditListingWizard.saveNewPricingProduct'
      //     : 'EditListingWizard.saveEditPricing';
      let submitButtonTranslationKey;
      if (isNewListingFlow && category === 'service') {
        submitButtonTranslationKey = 'EditListingWizard.saveNewPricingProduct';
      } else if (isNewListingFlow && category === 'product') {
        submitButtonTranslationKey = 'EditListingWizard.saveNewPricingProduct';
      } else {
