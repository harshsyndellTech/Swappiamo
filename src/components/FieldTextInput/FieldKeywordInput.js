...
class FieldKeywordInputComponent extends Component {
  constructor(props) {
    super(props);
    this.state = {
      type: 'password',
...
FieldKeywordInputComponent.defaultProps = {
  rootClassName: null,
  className: null,
  inputRootClass: null,
  onUnmount: null,
...
FieldKeywordInputComponent.propTypes = {
...
class FieldKeywordInput extends Component {
  ...
  render() {
    return <Field component={FieldKeywordInputComponent} {...this.props} />;
  }
}

export default FieldKeywordInput;
