...
export const BookingBreakdownComponent = props => {
  ...
  // console.log('BookingBreakdownComponent', props);
  ...
  const isRefund = refundTransitions.includes(lastTransition);
  const classes = classNames(rootClassName || css.root, className);
  if (isRefund && isProvider) {
    return (
      <div className={classes}>
        <FormattedMessage id="BookingBreakdown.BookingBreakdown.providerNote" />
      </div>
    );
  }
  /**
