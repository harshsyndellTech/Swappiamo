...
export const TRANSITION_ACCEPT_CUSTOMER = 'transition/customer-accept';
export const TRANSITION_PRODUCT_RECEIVED = 'transition/product-delivered';
// Admin can also cancel the transition.
export const TRANSITION_CANCEL = 'transition/cancel';
export const TRANSITION_DECLINE_CUSTOMER = 'transition/customer-decline';
// The backend will mark the transaction completed.
export const TRANSITION_COMPLETE = 'transition/product-delivered';
// export const TRANSITION_COMPLETE = 'transition/complete';
export const TRANSITION_OFFER_EXPIRE = 'transition/offer-expire';
export const TRANSITION_COMPLETE_SERVICE = 'transition/complete-service';
...
export const TRANSITION_CUSTOMER_EXPIRE = 'transition/customer-expire';
export const TRANSITION_COMPLETE_START = 'transition/complete-start';
export const TRANSITION_COMPLETE_END = 'transition/complete-end';
const STATE_OFFER_EXPIRED = 'expire';
/**
 * Actors
 *
...
const STATE_CUSTOMER_ACCEPTED = 'customer-accepted';
const STATE_CUSTOMER_DECLINED = 'customer-declined';
const STATE_SERVICE_COMPLETE = 'complete-service';
  ...
  states: {
    ...
    [STATE_PREAUTHORIZED]: {
      on: {
        ...
        [TRANSITION_OFFER_EXPIRE]: STATE_OFFER_EXPIRED,
      },
    },
    // [STATE_ACCEPTED]: {
    //   on: {
    //     [TRANSITION_ACCEPT_CUSTOMER]: STATE_CUSTOMER_ACCEPTED,
    //     [TRANSITION_DECLINE_CUSTOMER]: STATE_CUSTOMER_DECLINED,
    //     [TRANSITION_CUSTOMER_EXPIRE]: STATE_OFFER_EXPIRED,
    //   },
    // },
    [STATE_ACCEPTED]: {
      on: {
        [TRANSITION_PRODUCT_RECEIVED]: STATE_DELIVERED,
        [TRANSITION_COMPLETE_SERVICE]: STATE_SERVICE_COMPLETE,
        [TRANSITION_ACCEPT_CUSTOMER]: STATE_CUSTOMER_ACCEPTED,
        [TRANSITION_DECLINE_CUSTOMER]: STATE_CUSTOMER_DECLINED,
        [TRANSITION_CUSTOMER_EXPIRE]: STATE_OFFER_EXPIRED,
        [TRANSITION_COMPLETED]: STATE_DELIVERED,
        [TRANSITION_COMPLETED]: STATE_SERVICE_COMPLETE,
        [TRANSITION_COMPLETE_START]: STATE_SERVICE_COMPLETE,
      },
    },
    [STATE_SERVICE_COMPLETE]: {
      on: {
        [TRANSITION_COMPLETED]: STATE_DELIVERED,
        [TRANSITION_COMPLETE_END]: STATE_DELIVERED,
      },
    },
    ...
    [STATE_OFFER_EXPIRED]: { type: 'final' },
  },
};
...
export const txIsAcceptedByCustomer = tx =>
  getTransitionsToState(STATE_CUSTOMER_ACCEPTED).includes(txLastTransition(tx));

export const txIsDeclinedByCustomer = tx =>
  getTransitionsToState(STATE_CUSTOMER_DECLINED).includes(txLastTransition(tx));

export const txIsServiceComplete = tx =>
  getTransitionsToState(STATE_SERVICE_COMPLETE).includes(txLastTransition(tx));

export const txIsProductReceivedByCustomer = tx =>
...
export const txIsOfferExpired = tx =>
  getTransitionsToState(STATE_OFFER_EXPIRED).includes(txLastTransition(tx));
