...
import { transitionsToDelivered, transitionsToRequested } from '../util/transaction';
import { LISTING_STATE_DRAFT } from '../util/types';
import * as log from '../util/log';
import { authInfo, logout } from './Auth.duck';
import { stripeAccountCreateSuccess } from './stripeConnectAccount.duck';
import { util as sdkUtil } from '../util/sdkLoader';
import { fetchUsersForFilter } from '../containers/SearchPage/SearchPage.duck';
...
export const DELETE_ACCOUNT_REQUEST = 'app/user/DELETE_ACCOUNT_REQUEST';
export const DELETE_ACCOUNT_SUCCESS = 'app/user/DELETE_ACCOUNT_SUCCESS';
export const DELETE_ACCOUNT_ERROR = 'app/user/DELETE_ACCOUNT_ERROR';
export const SET_ERROR_NULL = 'app/user/SET_ERROR_NULL';
// ================ Reducer ================ //
...
export default function reducer(state = initialState, action = {}) {
  ...
  switch (type) {
    case CURRENT_USER_SHOW_REQUEST:
      return { ...state, currentUserShowError: null, currentUserLoading: true };
    ...
    case CURRENT_USER_SHOW_ERROR:
      ...
      return { ...state, currentUserShowError: payload, currentUserLoading: false };
...
export const deleteAccountError = e => ({
...
// ================ Thunks ================ //
export const deleteCurrentUser = password => (dispatch, getState, sdk) => {
  ...
  return deleteUserAccount({
    ...
    .catch(e => {
      //  console.log("helloiiiii",e)

      dispatch(deleteAccountError(storableError(e)));
    });
};
export const removeError = () => (dispatch, getState, sdk) => {
